                  ...
                  <div class="card-body">
                    <div class="card-head-row card-tools-still-right">
                      ...
                      <div class="card-tools">
                        <div class="dropdown">
                          ...
                          >
                            <a class="dropdown-item" href="{{ route('admin.user.list') }}">All Users</a>
                    ...
                    @foreach($latestUsers as $user)
                        <div class="item-list">
                            <div class="avatar">
                                <img
                                    src="{{ asset('storage/' . $user->identity_image) }}"
                                    alt="..."
                      ...
                      <div class="card-tools">
                        <div class="dropdown">
                          ...
                          <div
                            ...
                            aria-labelledby="dropdownMenuButton"
                          >
                            <a class="dropdown-item" href="{{ route('admin.user.list') }}">View All</a>
                            <a class="dropdown-item" href="#">Another action</a>
                            <a class="dropdown-item" href="#"
                              >Something else here</a
                            >
                      ...
                      <table class="table align-items-center mb-0">
                        ...
                        @foreach($latestTransactions as $transaction)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <span class="badge {{ $transaction->status === 1 ? 'badge-success' : 'badge-danger' }}">
